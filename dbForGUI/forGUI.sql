CREATE DATABASE  IF NOT EXISTS `fooddeliveryservice` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `client` (
  ...
  `Apartments` varchar(30) DEFAULT NULL,
...
INSERT INTO `client` VALUES (1,1234567890,'Ivan','Ivanov','Ivanovich','123-456-789','Lviv','Akademika Rudnytskoho','25'),(2,987654321,'Elena','Sidorova','Petrovna','987-654-321','Dnipro','Bihova','50'),(3,1357924680,'Aleksey','Petrov','Alekseevich','135-792-468','Kyiv','Baltiiska','10'),(4,321321,'dsadas','dasd','hello','132-312-141','dasd','adasdsa','sadas');
...
INSERT INTO `couriers` VALUES (1,312321312,3184232173,'free','hello','world','bib','1 years','by car',1.00),(2,987654,9876543210,'free','Emily','Johnson','Brown','5 years','by car',45.00),(3,321321,3198931278,'busy','Michael','Smith','Williams','2 years','by car',15.00),(4,312321,321312,'free','dsada','dsadas','sdasdas','5 years','by car',30.00);
...
INSERT INTO `ordered_food` VALUES (1,1,2),(1,3,1),(1,7,1),(2,7,2);
...
INSERT INTO `orders` VALUES (1,1,1,'2024-05-02','delivered',73.96),(2,2,2,'2024-06-11','delivered',64.98),(3,3,3,'2024-06-07','in progress',10.00),(4,4,4,'2024-06-03','delivered',1.00);
...
INSERT INTO `reports` VALUES (1,'2024-05-02',5,'Excellent service and food quality!','Very satisfied with the overall experience. Will definitely order again.'),(2,'2024-05-17',3,'Good delivery time, food was warm and tasty.','Overall, a positive experience but room for improvement in some areas.');
...
-- Dump completed on 2024-06-02 15:05:43
